...
def p2gg_generate_atoms_structure(cell: np.ndarray,
    ...
    # 对每个原子随机挑选一个对称操作进行应用
    for i in range(n):
        op = random.choice(p2gg_operations)
        R = op['rotation']
        t = op['translation']
        # 应用旋转和平移
